...
export default function SettingsScreen() {
  ...
  const { widget1Animations, widget2Animations, widget3Animations } = useAnimation();
    ...
    React.useCallback(() => {
      ...
      const animations = settingAnimations.current.map((anim, index) =>
        Animated.timing(anim, {
          toValue: 1,
          duration: 500,
          delay: index * 50, // Délai progressif pour chaque élément
        ...
        >
          <View style={styles.settingLeft}>
            <View style={[styles.settingIcon, { backgroundColor: color + '20' }]}>
              <Icon size={20} color={isDarkMode ? '#fff' : color} />
            </View>
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: isDarkMode ? '#1a1a1a' : '#f5f5f5' }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.footer}>
          ...
          <Text style={[styles.footerSubtext, { color: isDarkMode ? '#999' : '#999' }]}>
